  ...
  return (
    <>
      ...
      align-items-center">
        ...
        <div className="  container-fluid d-flex gap-5 align-items-center">

          {/*  ** ** ** Left section-- top strip  ** ** ** */}

          <div className="left-section-top-strip d-flex me-5  me-lg-0 me-md-3  me-sm-4" >

                                  {/* Logo slice */}
            <div className="navLogo d-flex  justify-content-center pe-2 pt-2 pb-1 ps-1 ">
              <NavLink className=" d-block justify-content-center">
                <img
                  className="navImg"
              ...
              <div className="logoText d-flex">
                <span>.eg</span>
                                  ...
                                  {/* Location slice */}
            <div className="location d-flex pt-2 pb-1 px-1 justify-content-center ">
              <div className="locationIco">
                <HiOutlineLocationMarker />
              </div>
              <div className="locationText  d-flex flex-column">
                <div className="d-flex">
                  <span className="text-capitalize">deliever</span> to
                </div>
          ...
          <div className="middle-section-top-strip d-flex flex-nowrap justify-content-center ms-lg-0 ms-5 ms-md-0
          align-self-baseline" >
            ...
            <div className="right-side-search search-ico d-flex  ms-0 ">
              <button
                className="nav-search-submit-button px-2 py-1"
                type="submit"
              >
                <HiOutlineSearch />
              </button>
          ...
          <div className="right-section-top-strip d-flex  align-items-end flex-nowrap justify-content-between me-2">
                                {/*  Lang slices */}
            <div className="lang-slice position-relative p-2  me-1 d-flex flex-row flex-nowrap align-items-end">
              <div id="flag-img">
            ...
            <div className="sign-in-slice position-relative pt-1 pb-1 ps-1">
              <div className="d-flex signIn-title lh-1 pt-0"> <span className="text-capitalize pe-1">hello, </span>sign in</div>
              <div className="signIn-dropDown-menu dropdown d-flex flex-nowrap flex-row">
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      new customer?
                      <NavLink className="text-decoration-none ps-1">
                        start here.
                      </NavLink>
                    </div>
                  </div>
                  ...
                  <div className="row d-flex flex-nowrap">
                    <div className="col-5 left-side ms-3 lh-lg">
                      ...
                      <div className="d-block"> create
                      <span className="text-lowercase"> a</span> list</div>
                    </div>
            ...
            <div className="cart-slice d-flex flex-row position relative p-1 ">
              <NavLink className='text-decoration-none'>
                <div className="cart-img d-flex justify-content-center">
                  ...
                  <span className="cart-items position-absolute d-block ms-2">0</span>
                </div>
              </NavLink>
