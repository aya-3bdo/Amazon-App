...
export default function MiddleCarousels() {
  ...
  return (
    <div className="middle-carousels-container container-xl mt-4">
      {/*  First Carousel */}
      <div className="first-carousel slider-container px-1 position-relative">
        <div className="slider-title pt-1">Shop top picks in sports
          <span className="ms-3">explore more</span>
        </div>
          <span className="left-arrow"><MdOutlineKeyboardArrowLeft/></span>
          <span className="right-arrow"><MdOutlineKeyboardArrowRight/></span>
      ...
      <div className="second-carousel slider-container px-1 position-relative mt-3 ">
        <div className="slider-title mb-1 pt-1">Shop the Budget Store
